                ...
                <div className="flex flex-wrap gap-3">
                  {collection.outfits.map((outfit) => (
                    <div
                      ...
                      className="flex items-center gap-3 px-4 py-2.5 rounded-full bg-ink/5 border border-ink/5 text-xs font-bold text-text-primary"
                    >
                      {outfit.outfitName}
                      <button
...
const OutfitPreviewThumb = ({ outfit }: { outfit: Outfit }) => {
  ...
  if (previewItems.length === 0) {
    return (
      <div className="w-full h-full bg-ink/5 flex items-center justify-center opacity-20">
        <LayoutGrid size={16} className="text-text-primary" />
      </div>
    );
  }
  return (
    <div className="w-full h-full grid grid-cols-2 gap-0.5 bg-ink/5">
        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
          ...
          >
            <div className="flex justify-between items-center p-8 pb-6 border-b border-ink/5 flex-shrink-0">
              ...
              <button onClick={onClose} className="p-3 hover:bg-ink/5 rounded-full transition-colors text-text-secondary hover:text-text-primary">
                <X size={20} />
              </button>
            </div>

            <div className="px-8 pt-5 flex-shrink-0">
              <div className="flex gap-2 p-1 bg-ink/[0.02] border border-ink/5 rounded-xl w-fit">
            ...
            <div className="px-8 py-5 border-b border-ink/5 flex-shrink-0 space-y-4">
                            ...
                            >
                              ...
                              <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                {isAdding ? (
                                  ...
                                  <div className="bg-accent text-on-accent p-1.5 rounded-full">
                                    <Check size={14} />
                                  </div>
                                )}
                              </div>
