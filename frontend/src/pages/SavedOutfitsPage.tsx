        ...
        <AnimatePresence mode="wait">
          {!showContent ? (
            ...
            >
              ...
              <button 
                onClick={() => navigate('/outfits/flat/new')}
                className="px-10 py-5 border border-ink/10 hover:border-ink/30 text-text-primary font-black rounded-full flex items-center gap-3 transition-all backdrop-blur-md"
              >
            ...
            >
              ...
              <motion.button
                ...
                onClick={() => navigate('/outfits/flat/new')}
                className="aspect-[3/4] rounded-[2rem] border-2 border-dashed border-ink/5 flex flex-col items-center justify-center gap-6 group hover:border-accent/40 hover:bg-accent/5 transition-all"
              >
                <div className="w-16 h-16 rounded-full bg-ink/5 flex items-center justify-center group-hover:bg-accent group-hover:text-on-accent transition-all shadow-xl">
                  <Plus size={24} />
                </div>
                <div className="text-center px-4">
                  <span className="text-[10px] font-black tracking-[0.3em] text-text-secondary group-hover:text-text-primary transition-colors uppercase">
